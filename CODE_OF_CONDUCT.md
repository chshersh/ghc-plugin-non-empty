...
participate in the `ghc-plugin-non-empty` project development.
...
The main concern of the project developers is friendliness and inclusion.
...
please notify Dmitrii Kovainikov (the current admin of
`ghc-plugin-non-empty`) as soon as possible.
